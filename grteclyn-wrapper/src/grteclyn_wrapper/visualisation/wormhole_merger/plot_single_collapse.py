...
BURGUNDY is the horizon instrument -- the oriented scan's MOTS -- and nothing
...
def main(argv: list[str] | None = None) -> int:
    ...
    axT.plot(hA["time"], hA["R_mots"], color=style.BURGUNDY, linewidth=0.0,
