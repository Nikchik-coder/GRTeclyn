#!/usr/bin/env bash
# Mass law, cell for M = 0.019172 (1.338 x the headline star).
#
...
#
# THE PAIRING.  omega_canonical = 0.700 gives M = +0.019172; the phantom
# partner was root-found to omega = 0.710478, matching |ADM| to +0.009%
...
# 1.002.  Expected a ~ 4.79e-05 and drift ~ +0.96 over t = 200, several
...
#
# CHECK FIRST.  omega 0.700 is outside the band the stability scan covered
...
BONDI_S0=0 BONDI_S1=1 BONDI_S0_OMEGA=0.700 BONDI_S1_OMEGA=0.710478 \
BONDI_GRTRESNA_N=256 BONDI_GRTRESNA_MAXLEVEL=0 BONDI_GRTRESNA_RANKS=32 BONDI_GRTRESNA_TIMEOUT=21600 \
BONDI_RUNS_DIR="${REPO}/runs/bondi/staging/masslaw_pair_d20_w0700_L64_N128_lev0" \
