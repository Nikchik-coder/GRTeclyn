#!/usr/bin/env bash
# Mass law, cell for M = 0.022541 (1.573 x the headline star).
#
...
#
# THE PAIRING.  omega_canonical = 0.675 gives M = +0.022541; the phantom
# partner was root-found to omega = 0.686063, matching |ADM| to -0.005%
...
# 1.002.  Expected a ~ 5.64e-05 and drift ~ +1.13 over t = 200, several
...
#
# CHECK FIRST.  omega 0.675 is outside the band the stability scan covered
...
BONDI_S0=0 BONDI_S1=1 BONDI_S0_OMEGA=0.675 BONDI_S1_OMEGA=0.686063 \
BONDI_GRTRESNA_N=256 BONDI_GRTRESNA_MAXLEVEL=0 BONDI_GRTRESNA_RANKS=32 BONDI_GRTRESNA_TIMEOUT=21600 \
BONDI_RUNS_DIR="${REPO}/runs/bondi/staging/masslaw_pair_d20_w0675_L64_N128_lev0" \
