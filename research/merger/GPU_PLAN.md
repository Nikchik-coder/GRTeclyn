...
- [ ] **Phase 3 — V1, head-on from rest, d = 8** → archive "Phase 3"
  ...
  - [ ] resolution alone: the level-5 restart from t = 22 (queue 1e, **in flight since 06:38 on card 2**) — passes the wall, or dies +1.4/level like the orbital pair
