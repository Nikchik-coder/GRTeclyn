...
- [ ] BBH vacuum control, same masses and momenta (§8.1) — **launched 2026-09-03 ~06:45 on card 1** as `bbh_control_d12_p012` (bare 0.9615 -> ADM ~ 1 each, d = 12, p = ±0.12, wormhole box + spheres, CCZ4 constants matched, vacuum dt/sigma); ~27 u/h, stop 100, pericenter ~43 expected
