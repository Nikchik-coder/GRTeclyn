...
- [ ] **Phase 3 — V1, head-on from rest, d = 8** → archive "Phase 3"
  ...
  - [ ] the fill-radius twin (queue 1f, **in flight since 06:39 on card 3**, from the t = 22 checkpoint) leaves r·ψ4 at R = 10/14/18 unchanged — the head-on's seam test
  - [ ] resolution alone: the level-5 restart from t = 22 (queue 1e, in flight since 06:38 on card 2) — **passed the wall at t = 27.05 (07:51)** with the fill off: χ resolved at 1.2e-6 (the scout had it on the 1e-20 floor from t = 24.5), max|K| 0.11 and falling (the scout's climbed from 0.19 at t = 25.5 to 209 at 26.90), Hamiltonian norm 1.65e-3 against the scout's 2.37e-3. Running on to t = 100 (~17 h at 4.2 units/h); whether the lapse keeps falling is the open part
...
Cards (2026-09-09 06:40): 0 busy (the V1c late-freeze arm since 04:47, the freeze arms at t = 26.5), 1 **free** (the low-mass head-on died at t = 14.00 at 06:33), 2 busy (the level-5 restart from t = 22, queue 1e), 3 busy (the fill-radius twin from t = 22, queue 1f). The t = 22 checkpoint (9.7 GB) is kept outside the rolling scratch and both restarts read it. Scratch: ~770 GB free (everything pruned
