> **Frozen 2026-09-09, verbatim.** The one living plan is `research/merger/GPU_PLAN.md`; this file is the model as the code solves it (M1–M7), the decision ledger and the validation passes to 2026-09-04, kept as written. The run record is `results/merger/README.md`.
