> **Frozen 2026-09-09, verbatim.** The one living plan is `research/merger/GPU_PLAN.md`; this file is the campaign record and stage plan to 2026-09-02, kept as written. The run record is `results/merger/README.md`.
