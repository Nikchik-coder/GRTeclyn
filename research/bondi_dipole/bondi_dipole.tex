...
\footnotetext[4]{Two late-time follow-ups: a recentring box carried to $t=784$ and a static-box control started off-centre to $t=600$, which together exclude the diagnostic box and place the opening on the grid; pair rigidity is quoted only to $t\approx500$ (Sec.~\ref{sec:caveats}). The $0.12c$ is the leading star's speed; the midpoint reaches $0.081c$.}
\end{table}
